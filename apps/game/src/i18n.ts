...
const STRINGS: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'duel.lead': 'Случайный соперник по видео. Загадайте желания, сыграйте дуэль — проигравший выполняет!',
    'duel.start': 'Начать',
    ...
    'duel.wishBody': 'Если он проиграет — выполнит это. Придумай что-нибудь весёлое!',
  ...
  en: {
    ...
    'duel.lead': 'A random video rival. Make a wish, duel it out — the loser performs it!',
    'duel.start': 'Start',
    ...
    'duel.wishBody': 'If they lose, they must do it. Make it fun!',
